...
INSERT INTO `brands` VALUES (1,'Ferrari');
...
INSERT INTO `car_classes` VALUES (1,'Low'), (2,'Mid'), (3,'High'), (4,'Exotic');
...
INSERT INTO `models` VALUES (1,'488 GTB',1), (2,'F8 Tributo',1), (3,'812 Superfast',1), (4,'Ferrari Portofino',1), (5,'SF90 Stradale',1);
...
INSERT INTO `users` VALUES (1,'IPopov','Ivan123!@#','ivan.popov@example.com','+359881234567',1), (2,'MIvanova','MariaPass!98','maria.ivanova@example.com','+359892345678',0), (3,'GPetrov','GeoPetro@2024','georgi.petrov@example.com','+359873456789',1), (4,'VStoyanova','Vessy@1234','vesela.stoyanova@example.com','+359884567890',0), (5,'NDimitrov','NikoPass!567','nikolay.dimitrov@example.com','+359895678901',0), (6,'PAsenov','m^zl400S','smart_garage_dp_user@abv.bg','+359881242513',0);
...
CREATE TABLE `cars` (
                        ...
                        KEY `cars_car_classes_id_fk` (`class_id`),
                        CONSTRAINT `cars_brands_id_fk` FOREIGN KEY (`brand_id`) REFERENCES `brands` (`id`),
                        CONSTRAINT `cars_car_classes_id_fk` FOREIGN KEY (`class_id`) REFERENCES `car_classes` (`id`),
...
INSERT INTO `cars` VALUES (1,'CB 4881 AM','ZFF79ALA0K0234567',1,1,2019,2,4), (2,'CB 8202 BB','ZFF92LLA1L0234568',1,2,2020,5,4), (3,'PB 8123 CC','ZFF87LAM2M0234569',1,3,2021,4,4), (4,'CA 2450 KH','ZFF89LLA8J0234570',1,4,2018,2,4), (5,'PB 9090 EX','ZFF94LAM0N0234571',1,5,2022,5,4);
...
INSERT INTO `parts` VALUES (1,'Brake Pads',120),
