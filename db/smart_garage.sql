...
CREATE TABLE `cars` (
                        ...
                        CONSTRAINT `cars_users_id_fk` FOREIGN KEY (`owner_id`) REFERENCES `users` (`id`)
...
INSERT INTO `cars` VALUES
                       (1,'CB 4881 AM','ZFF79ALA0K0234567',1,1,2019,2,4),
                       (2,'CB 8202 BB','ZFF92LLA1L0234568',1,2,2020,5,4),
                       (3,'PB 8123 CC','ZFF87LAM2M0234569',1,3,2021,4,4),
                       (4,'CA 2450 KH','ZFF89LLA8J0234570',1,4,2018,2,4),
                       (5,'PB 9090 EX','ZFF94LAM0N0234571',1,5,2022,5,4);
...
CREATE TABLE `services` (
                            ...
                            CONSTRAINT `services_cars_id_fk` FOREIGN KEY (`car_id`) REFERENCES `cars` (`id`)
